...
class SelectablePage(BasePage):
    ...
    def select_list_item(self):
        self.element_is_visible(self.locators.TAB_LIST).click()
        self.click_selectable_item(self.locators.LIST_ITEM, 4)
    ...
    def select_grid_item(self):
        self.element_is_visible(self.locators.TAB_GRID).click()
        self.click_selectable_item(self.locators.GRID_ITEM, 8)
...
class ResizablePage(BasePage):
    ...
    def change_size_resizable_box(self):
        title = self.element_is_visible(self.locators.RESIZABLE_TITLE)
        ...
        self.action_drag_and_drop_by_offset(self.element_is_present(self.locators.RESIZABLE_BOX_HANDLE), -350, -150)
    ...
    def change_size_resizable(self):
        aim = self.element_is_visible(self.locators.RESIZABLE_HANDLE)
        self.go_to_element(aim)
...
class DroppablePage(BasePage):
    ...
    def drop_accept(self):
        tab = self.element_is_visible(self.locators.ACCEPT_TAB)
        tab.click()
        self.go_to_element(tab)
    ...
    def drop_prevent_propogation(self):
        tab = self.element_is_visible(self.locators.PREVENT_TAB)
        tab.click()
        self.go_to_element(tab)
