...
class CheckBoxPage(BasePage):
    ...
    def get_checked_checkboxes(self):
        checked_list = self.elements_are_present(self.locators.ITEM_LIST)
        data = []
    ...
    def get_output_results(self):
        result_list = self.elements_are_present(self.locators.ITEM_LIST)
        data = []
