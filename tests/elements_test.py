...
class TestElements:
    ...
    class TestTextBox:
        ...
        def test_text_box(self, driver):
            ...
            assert permanent_address == output_permanent_address, "the permanent does not match"
    ...
    class TestWebTable:
        ...
        def test_web_table_search_person(self, driver):
            ...
            assert key_word in table_result, 'the person has not found in the table'
