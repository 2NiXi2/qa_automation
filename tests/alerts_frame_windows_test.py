...
class TestAlertsFrameWindow:
    ...
    class TestBrowserWindows:
        @allure.title('Checking the opening of a new and window')
        def test_new_tab(self, driver):
            browser_window_page = BrowserWindowsPage(driver, 'https://demoqa.com/browser-windows')
            browser_window_page.open()
            text_title_tab = browser_window_page.check_opened_new_tab('tab')
            text_title_window = browser_window_page.check_opened_new_tab('window')
            assert text_title_tab == 'This is a sample page', 'The tab has not opened or incorrect tab has opened'
            assert text_title_window == 'This is a sample page', 'The window has not opened or incorrect window has opened'
